...
public class SchemaTool {
    ...
    public static void main(String[] argv) throws Exception {
      ...
      ConfigValue<String> localSchema = Configuration.getString("videosearch.schema", null);
      ...
      if (localSchema.get() == null) {
        throw new IllegalArgumentException("Missing videosearch.schema value in configuration");
      }
    ...
    static CloudSearch buildAuthorizedClient() throws Exception {
      ...
      return new CloudSearch.Builder(
          ...
          credential)
          .setApplicationName("Video Connector")
          .build();
    }
